      ...
      <div className="max-w-7xl mx-auto py-6 sm:px-6 lg:px-8 text-white">
        ...
        <section className="mt-10 rounded-lg shadow-md">
          ...
          <p className="mt-2 text-gray-400">
            Check out the top 3 songs from the Billboard Hot 100 chart for this
            week.
          </p>
          <BillboardHot100 />
        </section>
        <section className="mt-10">
          ...
          <p className="mt-2 text-gray-400">
            Get some interesting and challenging trivia questions to engage your
            audience. Perfect for sparking conversations and adding fun to your
            show.
          </p>
          <ImpossibleTrivia />
        </section>
        ...
        <section className="mt-10 rounded-lg shadow-md">
          <h2 className="text-2xl font-bold text-white">New Music Releases</h2>
          <p className="mt-2 text-gray-400">
        ...
        <section className=" mt-10 rounded-lg shadow-md">
          ...
          <p className="mt-2 text-gray-400">
            Get your listeners engaged with fun and creative 'Would You Rather?'
            questions.
          </p>
          <WouldYouRather />
        </section>
        ...
        <section className="mt-10 rounded-lg shadow-md">
          ...
          <p className="mt-2 text-gray-400">
            Read about interesting and funny study results. See what the studies
            reveal about people's behaviors and habits.
          </p>
          <OurStudySays />
        </section>
        <section className="mt-10 rounded-lg shadow-md">
        ...
        <section className="mt-10 rounded-lg shadow-md">
          ...
          <p className="mt-2 text-gray-400">
            Enjoy a short talk break about a popular song from the Billboard Top
            100 chart from a random year between 1980 and 2024.
          </p>
          <Flashback />
        </section>
        <section className="mt-10 rounded-lg shadow-md">
